...
public:
	...
	Fl_Check_Button*	m_antiAliasCheckButton;
	Fl_Check_Button*	m_BSPCheckButton;
...
// static class members
	...
	static void cb_BSPCheckButton(Fl_Widget* o, void* v);
	static void cb_antiAliasCheckButton(Fl_Widget* o, void* v);
